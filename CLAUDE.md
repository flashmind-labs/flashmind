...
| `flashmind-tools`     | 50+ built-in tools + subagent tools + integrations (Google, Outlook, GitHub, Slack, CalDAV, Postgres, MySQL, ClickHouse, Redis, Docker, Cloudflare, SSH, K8s, Twilio/SMTP) + `ToolBuilder` |
